...
class Solution {
    public ListNode oddEvenList(ListNode head) {
        // 通过odd和even各自连接结点，最后拼接
        // 保持dummyOdd和dummyEven
        // 保持head作为遍历
        // 最终odd.next = dummyEven.next
        // even.next = null
...
// Your runtime beats 17.05 % of java submissions
// Your memory usage beats 5.08 % of java submissions (42.5 MB)
    }
}
// @lc code=end
